...
var app = angular.module('Qbox');
    ...
    app.controller('prepTestByInstQuestionCtrl',['$mdSidenav','$mdDialog','$scope','dataServiceFactory','institutions','$state','baseUrl',prepTestByInstQuestionCtrl]);

    function prepTestByInstQuestionCtrl($mdSidenav,$mdDialog,$scope,dataServiceFactory,institutions,$state,baseUrl){
